create or replace view SFDC.PUBLIC.CREDIT_PRIMARYOWNER_CONTACTID(
	"OpportunityId",
	...
	"Signer Contact"
) COMMENT='The table contains records of primary contact information for credit entities. Each record represents a single entity and includes details about the beneficial owner, business owner, guarantors, and signers.'
 as
    -- comment = '<comment>'
WITH
  "MANAGE COLUMNS" AS (
